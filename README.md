# DocDriven Code Assistant Setup: Rails

## Getting Started Guide

This is a basic configuration for *Rails* that will help you setup *DocDriven Code Assistant* to create the following:
...
>Download the repository content example as a zip file [here](https://github.com/docdrivencom/code-assistant-setup-rails/archive/refs/heads/main.zip).


**2. Unzip and Copy**

>Unzip the file and copy the `docdriven` directory and `docdriven.config.json` into the root of your *Rails* project where you want the *Code Assistant* to operate. Ensure your project is inside a GitHub repository.
